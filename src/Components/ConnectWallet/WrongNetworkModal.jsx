...
const WrongNetworkModal = ({handleClose}) => {
  ...
  const changeToMainnet = async () => {
    await Moralis.switchNetwork(DefaultChain);
    handleClose();
  }
    ...
    <div>
      <div className="connect-modal">
        ...
        <Modal.Body>
           ...
           <div className="text-center"> <button className="btn common_btn switch" onClick={changeToMainnet}>Switch to {DefaultChainName}</button></div>
           </div>
